...
then
  ...
  declare -a CHK_FILLIT='( "check_norme" "norminette" "check_fillit_makefile" "makefile" "check_fillit_forbidden_func" "forbidden functions" "check_fillit_extern_file" "extern file" "check_fillit_fillitchecker" "fillit_checker (${EXTERNAL_REPOSITORY_FILLITCHECKER_URL})" )'
  ...
  function check_fillit_extern_file
  {
    ...
    local -a ALLOWED_FILES='( "extern_file.txt" )'
